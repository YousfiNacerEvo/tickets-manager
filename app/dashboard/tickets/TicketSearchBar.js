...
export default function TicketSearchBar({ filters, setFilters }) {
  ...
  return (
    <div className="bg-white/90 border border-gray-200 rounded-xl shadow-sm p-6 mb-6 w-full max-w-4xl mx-auto text-black">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-bold text-blue-900 flex items-center gap-2">
          <svg className="w-5 h-5 text-blue-700" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>
          Ticket Filters
        </h2>
        <button
          onClick={handleReset}
          className="px-3 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 border border-gray-300 text-sm"
        >
          Reset
        </button>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="px-3 py-2 border border-gray-300 rounded outline-none focus:ring-2 focus:ring-blue-400 w-full"
            placeholder="ID"
          />
        </div>
        <div>
          ...
          <input
            ...
            className="mt-2 px-3 py-2 border border-gray-300 rounded outline-none focus:ring-2 focus:ring-blue-400 w-full"
